...
class DroneSimulator:
    ...
    def run(self) -> None:
        ...
        if self.__planning_toolkit is not None:
            self.__drone.set_landing_controller(OctomapLandingController(self.__drone, self.__planning_toolkit))
            self.__drone.set_takeoff_controller(OctomapTakeoffController(self.__drone, self.__planning_toolkit))
